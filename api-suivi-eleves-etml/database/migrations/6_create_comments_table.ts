...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('teacher_id').unsigned().nullable() // Important : un commentaire peut ne pas être lié à unenseignant.references('id').inTable('teachers').onDelete('SET NULL') // si l'enseignant est supprimé, le commentaire restera en DB mais sans être lié à un enseignant
